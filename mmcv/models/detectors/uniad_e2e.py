...
class UniAD(UniADTrack):
    ...
    def forward_test(self,
                     ...
                     # Those are used for visualization only if DEBUG
                     gt_bboxes_3d=None, 
                     sender_gt_bboxes_3d=None,
                     **kwargs
                    ):
        ...
        result_track = self.simple_test_track(img, l2g_t, l2g_r_mat, img_metas, timestamp, sender_img, sender_img_metas, gt_bboxes_3d, sender_gt_bboxes_3d)
